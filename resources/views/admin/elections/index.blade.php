                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-700">
                                                <div class="flex flex-wrap gap-2">
                                                    ...
                                                    <a href="{{ route('admin.elections.edit', $election) }}"
                                                       class="inline-flex items-center px-3 py-2 bg-gray-900 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                                                        Editar
                                                    </a>
                                                </div>
                                            </td>
